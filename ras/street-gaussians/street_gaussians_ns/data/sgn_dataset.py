...
class InputDataset(Dataset):
    ...
    def get_image_float32(self, image_idx: int) -> Float[Tensor, int]:
        """Returns a 3 channel image in float32 torch.Tensor.

        Args:
            image_idx: The image index in the dataset (image_height, image_width, num_channels)
        """
    ...
    def get_image_uint8(self, image_idx: int) -> UInt8[Tensor, int]:
